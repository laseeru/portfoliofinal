            ...
            <div className="flex justify-center lg:justify-end animate-fade-up delay-200">
              <div className="relative">
                ...
                <img
                  ...
                  className="relative w-72 h-72 md:w-96 md:h-96 object-cover rounded-full border-4 border-primary-foreground/20 shadow-2xl"
                />
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { number: "YVA", label: "2025 Speaker" },
              { number: "Cuba", label: "Medical Training" },
              { number: "AI×Health", label: "Focus Area" },
            ].map((stat, index) => (
              <div
                key={stat.label}
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={area.title}
                className="glass-card rounded-xl p-6 hover:shadow-xl transition-all duration-300 animate-fade-up"
